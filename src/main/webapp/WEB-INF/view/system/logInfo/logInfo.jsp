    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="padding: 5px">
                <input type="text" name="logname" autocomplete="off" class="layui-input layui-input-inline"
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="padding: 5px">
                <input type="text" name="log" autocomplete="off" class="layui-input layui-input-inline"
                       placeholder="请输入操作事件" style="height: 30px;border-radius: 10px">
            </div>
        </div>
        <div class="layui-inline">
    ...
    layui.use(['jquery', 'layer', 'form', 'table','laydate'], function () {
        ...
        tableIns = table.render({
            ...
            , cols: [[   //列表数据
                ...
                , {field: 'logname', title: '操作人名称', align: 'center'}
                , {field: 'logip', title: '操作IP', align: 'center'}
                , {field: 'log', title: '操作事件', align: 'center'}
        ...
        $("#doSearch").click(function () {
            ...
            //alert(params);
            tableIns.reload({
                url: "${yeqifu}/log/loadAllLogInfo.action?" + params,
                page:{curr:1}
            })
        });
