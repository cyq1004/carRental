...
<form class="layui-form" id="loginFrm" method="post" action="${yeqifu}/login/login.action" style="display: block">
    <div class="login_face"><img src="${yeqifu}/static/images/tx.png" class="userAvatar"></div>
...
<form class="layui-form" id="registerFrm" method="post" action="${yeqifu}/register/register.action" style="height: 65%;display: none">
    <div class="login_face"><img src="${yeqifu}/static/images/tx.png" class="userAvatar"></div>
    <div class="layui-form-item input-item">
        <label for="loginname">用户名</label>
        <input type="text" placeholder="请输入用户名" autocomplete="off" name="loginname" id="loginname" class="layui-input" lay-verify="required">
    ...
    <div class="layui-form-item input-item">
        ...
        <input type="text" placeholder="请输入手机号" autocomplete="off" name="phone" id="phone" class="layui-input" lay-verify="required">
    </div>
    <div class="layui-form-item input-item">
        <label for="pwd">密码</label>
        <input type="password" placeholder="请输入密码" autocomplete="off" name="pwd" id="pwd" class="layui-input" lay-verify="required">
    ...
    <div class="layui-form-item input-item">
        ...
        <input type="Password" placeholder="请再次输入密码" autocomplete="off" name="confirmPwd" id="pwd" class="layui-input" lay-verify="required">
    </div>
    <div class="layui-form-item input-item" id="imgCode">
        <label for="code">验证码</label>
        <input type="text" placeholder="请输入验证码" autocomplete="off" name="code" id="code" class="layui-input">
...
<div style="text-align: center;color: green; margin-left: 800px; margin-top: 600px">
    ${success}
</div>
<div style="text-align: center;color: red; margin-left: 800px; margin-top: 600px">
    ${error}
</div>
...
<script type="text/javascript">
    function register() {
        var login = document.getElementById("loginFrm");
        var register = document.getElementById("registerFrm");
