...
public class ValidUtil {
    ...
    public static boolean isEmpty(Object value) {
        return (null == value || (value instanceof String && cn.hutool.core.util.StrUtil.isEmpty((String) value)));
    }
    ...
    public static boolean isLetter(CharSequence value) {
        return cn.hutool.core.util.StrUtil.isAllCharMatch(value, new cn.hutool.core.lang.Matcher<Character>() {
            @Override
