...
public class ResultObj {
     ...
     * 添加用户核验
     */
    public static final ResultObj IDENTITY_ERROR = new ResultObj(SysConstant.CODE_ERROR, SysConstant.IDENTITY_ERROR);
    public static final ResultObj ADD_PHONE_ERROR = new ResultObj(SysConstant.CODE_ERROR, SysConstant.ADD_PHONE_ERROR);
    public static final ResultObj ADD_LoginName_ERROR = new ResultObj(SysConstant.CODE_ERROR, SysConstant.ADD_LoginName_ERROR);
